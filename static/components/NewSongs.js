export default {
    ...
    <div>
    <div align="center">
    <img width="100" height="100" src="https://img.icons8.com/ios-glyphs/100/new.png" alt="new"/>
    <div class="container" align="center">
        <ul class="list-group mx-auto" style="max-width: 600px;">
        <li class="list-group-item bg-dark text-light">
          <h4 class="mb-0">Recently Added Songs</h4>
        </li>
      ...
      <div v-if="isPlaying" class="col-4">
        ...
        computed: {
            filteredItems() {
                ...
                return this.musiclist.sort((a, b) => b.music_id - a.music_id).slice(0, 5);
            },
        },
        mounted() {
            this.getTracks();
